...
void SceneManager::DefineObjectMaterials()
{
	...
	orangeMaterial.ambientColor = glm::vec3(0.1f, 0.1f, 0.1f);
	orangeMaterial.ambientStrength = 0.1f;
	orangeMaterial.diffuseColor = glm::vec3(0.3f, 0.2f, 0.3f);
	orangeMaterial.specularColor = glm::vec3(0.4f, 0.2f, 0.2f);
	orangeMaterial.shininess = 0.5;
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.50f, 0.50f, 0.50f);
...
void SceneManager::LoadSceneTextures()
{
	...
	// Free textures created by Michael Damico
	// Loaded textures to apply to shapes
	bReturn = CreateGLTexture(
		"textures/Wood.jpg", "Wood");

	bReturn = CreateGLTexture(
		"textures/SteelMajor.jpg", "SteelMajor");

	bReturn = CreateGLTexture(
		"textures/SteelMinor.jpg", "SteelMinor");

	bReturn = CreateGLTexture(
		"textures/rubikCube.jpg", "RubikCube");

	bReturn = CreateGLTexture(
		"textures/Coaster.jpg", "Coaster");
...
{
	// load textures for objects in the scene
	LoadSceneTextures();
...
{
	// function calls to modular scene items
	RenderTable();
	RenderSteelCup();
	RenderOrangeFruit();
	RenderCoaster();
 ...
 *  RenderSteelCup()
 *
 *  This method is called to render the shapes for the SteelCup
 ****************************************************************/
void SceneManager::RenderSteelCup()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 4.0f, 5.0f);
	...
	//SetShaderColor(0.41, 0.46, 0.57, 1);
	SetShaderTexture("SteelMajor");
	SetTextureUVScale(1.0, 1.0);
	...
	// ******************************************************************
	// TORUS FOR LIP OF THE CUP
	// ******************************************************************

	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.90f, 0.90f, 0.40f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 3.92f, 5.0f);
	...
	//SetShaderColor(0.341, 0.447, 0.565, 1);
	SetShaderTexture("SteelMinor");
	SetTextureUVScale(1.0, 1.0);
	SetShaderMaterial("metal");
...
void SceneManager::RenderOrangeFruit()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.2f, 2.0f, 4.5f);
	...
	//SetShaderColor(1.00, 0.50, 0.15, 1);
...
void SceneManager::RenderCoaster()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.7f, 1.5f, 7.0f);
	...
	//SetShaderColor(0.73, 0.48, 0.34, 1);
...
void SceneManager::RenderRubikCube()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.7f, 2.1f, 7.0f);
